    ...
    def __init__(
        ...
        *,
        ...
        if hf_pretrained is not None:
            ...
            self.pipe = StableDiffusionPipeline.from_pretrained(hf_pretrained)
        else:
            ...
            with patched(
                StableDiffusionSafetyChecker, "from_pretrained", lambda *arg: None
            ):
                self.pipe = load_pipeline_from_original_stable_diffusion_ckpt(
                    ckpt_path, from_safetensors=ckpt_path.endswith(".safetensors")
                )
